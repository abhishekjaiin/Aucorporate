...
import { Cpu, Factory, Landmark, Handshake, ArrowRight, Sparkles } from "lucide-react"
  ...
  return (
    <main className="text-gray-800 leading-7">
      ...
      >
        ...
        <svg aria-hidden="true" className="absolute left-6 bottom-6 h-24 w-24 opacity-20 sm:left-16" viewBox="0 0 100 100" fill="none">
          <g fill="#facc15">
      ...
      <article className="max-w-4xl mx-auto px-6 py-12">
        ...
        <h2 className="text-2xl font-semibold mt-10 mb-4" style={{ color: NAVY }}>
        ...
        <p className="mb-6 font-medium" style={{ color: NAVY }}>
        ...
        <div
          className="my-10 rounded-2xl p-8 text-center text-white"
          style={{ background: `linear-gradient(135deg, ${NAVY} 0%, #0d2a5c 100%)` }}
        >
          <p className="text-lg font-semibold mb-2">
            Evaluating an India investment, manufacturing facility, GCC, or joint venture?
          </p>
          <p className="text-white/70 mb-6 text-sm max-w-xl mx-auto">
            AU Corporate helps Japanese businesses structure, establish, and operate their India entry — from entity selection through ongoing tax and regulatory compliance.
          </p>
          <Link
            href="/contact#inquiry-form"
            className="inline-flex items-center gap-2 rounded-md px-6 py-3 font-semibold text-black transition hover:opacity-90"
            style={{ backgroundColor: "#facc15" }}
          >
            Talk to Our Japan Desk <ArrowRight size={16} />
          </Link>
        </div>
