...
4. **SAC Code 9983 and the 18% GST rate** — 18% rate confirmed. SAC code precision is **unresolved**: Stage 9 found conflicting sources (broad 9983 vs. narrower 9984/998439) and recommends professional confirmation against the actual GST rate notification before this is used on customer-facing invoicing guidance. Page does not currently rely on the SAC code for anything beyond a passing mention — flagged for Stage 10/11 to decide whether to keep, caveat, or remove the specific code.
