...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://www.theaucorp.com/india-business-setup/company-formation' },
  openGraph: {
    title: 'Company Formation in India for Foreign Companies | AU Corporate',
    description: 'A practical guide to company formation and registration in India for foreign investors, including entity selection, incorporation, FDI and compliance.',
