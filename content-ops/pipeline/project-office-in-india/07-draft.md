...
**Project Office** — Set up for the limited duration of a specific contract, typically where a foreign company has secured a project from an Indian company and needs a temporary India-based presence to execute it. It is registered through the same Form FNC-1/Regulation 5 route used for a Branch or Liaison Office, though — as this guide explains in the registration section below — unlike a Branch or Liaison Office, it does not appear to be allotted a Unique Identification Number (UIN).
...
One point worth flagging precisely: unlike a Branch or Liaison Office, a Project Office does not appear to be allotted a **Unique Identification Number (UIN)**. RBI's UIN-allotment provision is consistently described, across independent sources, as applying to BO/LO specifically — not BO/LO/PO — which is a real and recurring distinction rather than an inconsistency in how different sites happen to paraphrase the same rule. This is the better-evidenced position, though it hasn't been confirmed against RBI's own primary regulation text directly. What is well established, and not in doubt, is that Form FNC-1, filed through the AD Category-I bank, is the operative application tied to Regulation 5's general-permission conditions — that mechanism is settled regardless of the UIN position.
...
1. **The UIN question (Section 5 body, comparison table, and FAQ #6) — REVISED per Stage 9's fact-check.** Updated to state, as the better-evidenced conclusion, that a Project Office does not appear to be allotted a UIN — based on Stage 9's finding of a high-authority Nishith Desai FAQ statement stating this directly, plus a recurring, independently-sourced phrasing pattern in the UIN-allotment provision that names "BO/LO" specifically (not "BO/LO/PO," which is how sources describe rules that genuinely do apply to all three structures). This is convergent secondary evidence, clearly labeled as such, not a primary RBI-text read — Stage 9 could not WebFetch rbi.org.in itself (egress-blocked throughout every stage of this and the two sibling pipelines). A compliance professional should still confirm this against the Gazette-notified FEMA 22(R)/2016-RB or Master Direction text directly before publish. Per Stage 9's explicit recommendation, the two live sibling pages (`/branch-office-in-india`, `/liaison-office-in-india`) do NOT need correction — their existing flat "no UIN for PO" statement is, per Stage 9, the better-supported position; this page's revision brings it into alignment with them rather than requiring any change on their end.
...
4. **The six-month opening window + discretionary six-month extension — confidence upgraded per Stage 9's fact-check.** Stage 9 found this figure corroborated across many more independent sources than originally known (ipandlegalfilings.com, taxguru.in, masllp.com, gkkediaandco.com, bizfoc.com), so the hedge in the registration section and FAQ #11 has been softened from "found on only one source" to "well-corroborated across multiple independent sources, not confirmed against the Master Direction text directly." A professional should still do the final primary-text check before this is stated as fully confirmed.
